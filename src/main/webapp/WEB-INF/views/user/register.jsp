		...
		<div class="col-md-6 col-md-offset-3">
			<form role="form" class="form-horizontal" name="registerForm" id="registerForm">
				...
				<div class="form-group">
					...
					<input type="password" class="form-control" id="passwordCheck" name="userPw" /> 
					<span id="resultPwCheck"></span> <br />
				</div>
				<hr />
				<div class="form-group">
				...
				<div class="form-group">
					...
					<span id="PhoneNumCheck">(-)을 제외한 번호를 적어주세요 ex)01012345678</span><br /><br />
				</div>
