	...
	<script>
		function list(page) {
			location.href = "/jihyunboard/board/myList?currentPage=" + page
							...
							+ "&keyword=<c:out value='${boardPageHelper.keyword}'/>&dateKeyword=${boardPageHelper.dateKeyword}";
		}
	</script>
</head>
<body>
	<div id="wrapper">
		...
		<form class="form-inline" name="searchForm" method="get" action="${path }/board/myList">
			...
			<table style="width: 100%">
				<tr>
					<td style="text-align: left">
						<a href="${path }/board/list" class="copperBtn generalBtn"> 
							<img id="mydocument" src="<c:url value='/resources/img/back.png'></c:url>" />전체 글 보기
						</a>
					</td>
