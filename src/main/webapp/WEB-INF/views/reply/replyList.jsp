...
<body>
	...
	<div id="paging">
		<nav aria-label="Page navigation">
			<ul class="pagination">
				<li><c:if test="${replyPageHelper.curBlock > 1}">
						<a href="javascript:replyList('1')" aria-label="Previous"> <span
							aria-hidden="true">&laquo;</span>
						</a>
						<a href="javascript:replyList('${replyPageHelper.prevPage}')"
							aria-label="Previous"> <span aria-hidden="true">&lt;</span>
						</a>
					</c:if></li>
				<li><c:forEach var="num" begin="${replyPageHelper.blockBegin}"
						end="${replyPageHelper.blockEnd}">
						<c:choose>
				...
				<li><c:if
						test="${replyPageHelper.curBlock <= replyPageHelper.totalBlock}">
						<a href="javascript:replyList('${replyPageHelper.nextPage}')"
							aria-label="Next"> <span aria-hidden="true">&gt;</span>
						</a>
						<a href="javascript:replyList('${replyPageHelper.totalPage}')"
